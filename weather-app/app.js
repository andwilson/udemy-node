...
googleApiKey = 'AIzaSyDhZb6l2z6x3Pl8R1WroUEau_zMj1KzUSc';
darkSkyApiKey = '4a04d1c42fd9d32c97a2c291a32d5e2d';
...
axios.get(geocodeUrl).then((response) => {
  ...
  console.log(`Searching weather for: ${response.data.results[0].formatted_address}`);
